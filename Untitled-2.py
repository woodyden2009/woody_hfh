...
while True:
    ...
    if menu == "1":
        ...
        work = input( "Ты находишься на работе, ( Зарабатывать ты можешь решая примеры аываы) выбери куда ты хочешь переместиться:\n1 - Главное меню\n2 - Начать работу: ")
        if work == "1":
            continue
        if work == "2":
            primer()
        ...
        if plushka1 == 1:
            print("У тебя есть красная кепка.")
        elif plushka2 == 1:
            print("У тебя есть оранжевое худи.")
        elif plushka3 == 1:
            print("У тебя есть пляжные шорты")
        else:
            print("У тебя нет аксессуаров, приобрести ты их можешь в магазине.")
        input("Чтобы выйти нажми Enter")
